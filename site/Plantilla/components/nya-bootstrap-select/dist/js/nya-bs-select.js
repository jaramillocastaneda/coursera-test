...
nyaBsSelect.provider('nyaBsConfig', function() {
  ...
  var defaultText = {
    'en-us': {
      ...
      noSearchResult: '',
      numberItemSelected: '%d items seleccionados',
...
nyaBsSelect.directive('nyaBsSelect', ['$parse', '$document', '$timeout', '$compile', 'nyaBsConfig', function ($parse, $document, $timeout, $compile, nyaBsConfig) {
  ...
  var DROPDOWN_TOGGLE = '<button class="btn dropdown-toggle" type="button">' +
  ...
  var NO_SEARCH_RESULT = '<li class="no-search-result"><span>Ningun Resultado encontrado</span></li>';
